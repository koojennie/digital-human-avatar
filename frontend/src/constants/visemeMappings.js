const visemesMapping = {
  ...
  D: "jawOpen",          // AA (Terbuka lebar)
  E: "mouthFunnel",      // AO, ER (Bentuk O)
  F: "mouthPucker",      // UW, OW, W (Bibir maju/mencucu)
  G: "mouthRollLower",   // F, V (Bibir bawah ke dalam)
  H: "jawOpen",          // L (Lidah/terbuka)
